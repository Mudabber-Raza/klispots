...
const HealthWellnessListing = () => {
  ...
  const cities = getHealthWellnessCities();
  const types = getHealthWellnessTypes();
  ...
  const filteredAndSortedVenues = useMemo(() => {
    let filtered = healthWellnessVenues;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-gray-900">
                Discover Amazing <span className="text-emerald-600">Health & Wellness</span>
              </h1>
              <p className="text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto">
                Find the perfect spot for your wellness journey, medical care, spa treatments, or just taking care of yourself in Pakistan's best health and wellness venues
              </p>
            </div>
          </div>
        </section>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <Input
                            placeholder="Search health & wellness venues..."
                            value={searchQuery}
                            onChange={(e) => {
              ...
              <div className="flex-1">
                        ...
                        <Card className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                          <div className="listing-card-container">
                            ...
                            <div className="absolute top-3 left-3">
                              <Badge className="bg-green-100 text-green-800">
                                {venue.facility_type || 'Health & Wellness'}
                              </Badge>
                            </div>
                          ...
                          <CardContent className="p-4 sm:p-6">
                            <div className="mb-4">
                              ...
                              <p className="text-gray-600 mb-2">{venue.facility_type || 'Health & Wellness'}</p>
                ...
                {currentPageVenues.length === 0 && filteredAndSortedVenues.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">No health & wellness venues found</h3>
...
export default HealthWellnessListing;