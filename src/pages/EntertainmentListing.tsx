...
const EntertainmentListing = () => {
  ...
  const cities = getEntertainmentCities();
  const types = getEntertainmentTypes();
  ...
  const filteredAndSortedVenues = useMemo(() => {
    let filtered = entertainmentVenues;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-gray-900">
                Discover Amazing <span className="text-emerald-600">Entertainment</span>
              </h1>
              <p className="text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto">
                Find the perfect spot for your fun, games, movies, or just enjoying yourself in Pakistan's best entertainment venues
              </p>
            </div>
          </div>
        </section>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <Input
                            placeholder="Search entertainment venues..."
                            value={searchQuery}
                            onChange={(e) => {
                        ...
                        <Card className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                          <div className="listing-card-container">
                            <ComprehensiveVenueImage
                              ...
                              alt={venue.place_name || 'Entertainment venue'}
