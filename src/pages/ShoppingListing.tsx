...
const ShoppingListing = () => {
  ...
  const cities = getShoppingCities();
  const themes = getShoppingThemes();
  ...
  const filteredAndSortedVenues = useMemo(() => {
    ...
    if (selectedTheme !== 'all') {
      filtered = filtered.filter(venue => 
        (venue.mall_theme || '').toLowerCase().includes(selectedTheme.toLowerCase())
      );
    }
    ...
    return filtered;
  }, [searchQuery, selectedCity, selectedTheme, sortBy]);
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-gray-900">
                Discover Amazing <span className="text-emerald-600">Shopping</span>
              </h1>
              <p className="text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto">
                Find the perfect spot for your retail therapy, fashion shopping, electronics, or just exploring unique markets in Pakistan's best shopping destinations
              </p>
            </div>
          </div>
        </section>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <Input
                            placeholder="Search shopping venues..."
                            value={searchQuery}
                            onChange={(e) => {
                      ...
                      {/* Theme Filter */}
                      <div>
                        <label className="text-sm font-medium text-gray-700 mb-2 block">Mall Theme</label>
                        <Select value={selectedTheme} onValueChange={(value) => {
                          ...
                          <SelectContent>
                            ...
                            {themes.filter(theme => theme && theme.trim()).map(theme => (
              ...
              <div className="flex-1">
                        ...
                        <Card className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                          <div className="listing-card-container">
                            <ComprehensiveVenueImage
                              ...
                              alt={venue.place_name || 'Shopping venue'}
                          ...
                          <CardContent className="p-4 sm:p-6">
                            <div className="mb-4">
                              ...
                              <p className="text-gray-600 mb-2">{venue.venue_type}</p>
                ...
                {currentPageVenues.length === 0 && filteredAndSortedVenues.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">No shopping venues found</h3>
